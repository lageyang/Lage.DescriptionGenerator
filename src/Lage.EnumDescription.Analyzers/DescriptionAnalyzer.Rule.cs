...
namespace Lage.EnumDescription.Analyzers
{
    public partial class DescriptionAnalyzer : DiagnosticAnalyzer
    {
        ...
        /// </summary>
        private static readonly DiagnosticDescriptor RuleTargetClass = new DiagnosticDescriptor(
            id: "Lage001",
        ...
        /// </summary>
        private static readonly DiagnosticDescriptor RuleParentClass = new DiagnosticDescriptor(
           id: "Lage002",
